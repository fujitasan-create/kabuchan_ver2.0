    ...
    <div className="knowledge-container">
      <div className="knowledge-row">
        ...
        <OptionBubble title="どんなことができるの？" options={[]} backLink={true}>
          ...
          <p className="knowledge-text">
            まず、<strong>日本に上場している4,412銘柄、そしてS&P500構成銘柄やFTSE100など</strong>に対応していて、それぞれの銘柄について、現在の株価やPER、時価総額などの基本情報を調べてお伝えできるよ。
          </p>
          <p className="knowledge-text">
            株価のグラフを描くことも得意なんだ。<strong>ローソク足はもちろん、RSI、MACD、ボリンジャーバンドといったテクニカル指標も表示できる</strong>から、視覚的に分析したい人にも役立ててもらえると思うよ！
          </p>
          <p className="knowledge-text">
            あとね、今日のニュースを読み取って、全体の雰囲気を分析する機能もあるの。市場がポジティブな空気なのか、それとも少し不安定なのか、ざっくりとした<strong>「今のムード」</strong>を知る手がかりになるはずだよ。
          </p>
          <p className="knowledge-text">
